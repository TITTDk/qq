...
Copyright (c) 2021  Asm Safone <https://github.com/MariaSource>
...
async def not_chat(_, m: Message):
    buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/MariaSource"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/xTaim"),
            ],
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://heroku.com/deploy?template=https://github.com/MariaSource/RadioPlayerV3"),
            ]
         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/4e839766d45935998e9c6.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Make Your Own Bot Like This From The [Source Code](https://github.com/MariaSource/RadioPlayerV3) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
